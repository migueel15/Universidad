...
public class Panel extends JPanel {
  ...
  public int numero1() { return Integer.parseInt(numero1.getText()); }

  // Devuelve el entero que tiene el JTextField numero 2
  public int numero2() { return Integer.parseInt(numero2.getText()); }

  // Devuelve el entero que tiene el JTextField numero 3
  public int numero3() { return Integer.parseInt(numero3.getText()); }
  ...
  public void escribePrimosTwin(List<Primos> list) {
    ...
    for (int i = 0; i < list.size(); i++) {
      ...
      // si es multiplo de 5 añado retorno de carro
      if(contador == 5){
        listaPrimos1.append("\n");
        contador = 1;
      }else{
  ...
  public void limpiaAreaTwin() { listaPrimos1.setText(""); }

  // Limpia el JTextArea listaPrimos2
  public void limpiaAreaCousin() { listaPrimos2.setText(""); }

  // Limpia el JTextArea listaPrimos3
  public void limpiaAreaSexy() { listaPrimos3.setText(""); }

  // Establece mensaje que se le pasa el JLabel mensaje
  public void mensaje(String str) { mensaje.setText(str); }

  // Establece mensaje que se le pasa el JLabel mensaje1
  public void mensajeTwin(String str) { mensaje1.setText(str); }

  // Establece mensaje que se le pasa el JLabel mensaje2
  public void mensajeCousin(String str) { mensaje2.setText(str); }

  // Establece mensaje que se le pasa el JLabel mensaje3
  public void mensajeSexy(String str) { mensaje3.setText(str); }

  // Establece el nivel de progreso n en el JProgressBar progreso1
  public void progreso1(int n) { progreso1.setValue(n); }

  // Establece el nivel de progreso n en el JProgressBar progreso2
  public void progreso2(int n) { progreso2.setValue(n); }

  // Establece el nivel de progreso n en el JProgressBar progreso3
  public void progreso3(int n) { progreso3.setValue(n); }
}
