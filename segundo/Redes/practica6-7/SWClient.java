...
public class SWClient {
  ...
  public int countResources(String resource) {
    ...
    try {
      ...
      HttpsURLConnection connection =
          (HttpsURLConnection)service.openConnection();
      ...
      ResourceCountResult c =
          parser.fromJson(new InputStreamReader(in), ResourceCountResult.class);
      numero = c.count;
  ...
  public Person searchPersonByName(String name) {
    ...
    try {
      ...
      InputStream in = connection.getInputStream();
      QueryResponse q =
          parser.fromJson(new InputStreamReader(in), QueryResponse.class);
      p = q.results[0];
