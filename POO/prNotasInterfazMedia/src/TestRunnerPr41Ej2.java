...
public class TestRunnerPr41Ej2 {
	...
	public static class JUnitTestAlumno {
		...
		public void alumnoEqualsTest1() throws Exception {
			...
			//------------------------
			Alumno an2 = new Alumno(new String("22456784F"), new String("Gonzalez Perez, Juan"), 7.7);
			...
			//------------------------
			Alumno an3 = new Alumno(new String("22456784f"), new String("Gonzalez Perez, Juan"), 7.7);
