...
def run_simulation():
    ...
    while True:
        ...
        pygame.draw.line(
            ...
            (255, 255, 255),
            pos_b,
            (pos_b[0] + vec_rot.x, pos_b[1] + vec_rot.y),
            2,
        )
        ...
        screen.blit(
            font.render(
                f"Velocidad Bola: {body_b.velocity.length:.1f} px/s", True, (0, 0, 0)
            ),
            (x0, y0),
        )
        screen.blit(
            font.render(
                f"Momento lineal inicial: ({P0.x:.2f},{P0.y:.2f}) kg·px/s ",
                True,
                (50, 50, 50),
            ),
            (x0, y0 + 1 * dy),
        ...
        screen.blit(
            font.render(
                f"Momento lineal bola:   ({Pb.x:.2f},{Pb.y:.2f}) kg·px/s ",
                True,
                (50, 50, 50),
            ),
            (x0, y0 + 2 * dy),
        ...
        screen.blit(
            font.render(
                f"Momento lineal pared:   ({Pp.x:.2f},{Pp.y:.2f}) kg·px/s ",
                True,
                (50, 50, 50),
            ),
            (x0, y0 + 3 * dy),
        ...
        screen.blit(
            font.render(
                f"Momento lineal TOTAL:   ({P.x:.2f},{P.y:.2f}) kg·px/s ",
                True,
                (50, 50, 50),
            ),
            (x0, y0 + 4 * dy),
        ...
        screen.blit(
            font.render("ESC: Reiniciar lanzamiento", True, (50, 50, 50)),
            (x0, y0 + 6 * dy),
        )
