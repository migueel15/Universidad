...
La clase coincide en buena parte con las diapositivas de [1.5. Basic Concepts on Statistics](../temario/bloque-1/1-5-conceptos-basicos-de-estadistica.md), que se vieron parcialmente en esta sesión. Allí se desarrolla el contenido visual completo (19 diapositivas); estos apuntes conservan además las explicaciones orales y los ejemplos debatidos. La transcripción añade, entre otros, PSI, ANOVA, Mann–Whitney, tratamiento del desbalance y RAG.
...
| Exponencial | Modela tiempos entre eventos en determinados procesos; se relaciona con el proceso de Poisson. |
...
La geometría a la que se refiere la transcripción es \(\lVert e\rVert_1=\sum_i|e_i|\) y \(\lVert e\rVert_2=\sqrt{\sum_i e_i^2}\). Por tanto, **MSE no es la norma \(L_2\)**: es el promedio de los errores al cuadrado. Las diapositivas del punto 1.5 presentan estas diferencias con ejemplos.
...
Las diapositivas usan 70 % / 15 % / 15 % como ejemplo de reparto; no es una proporción universal. El reparto se adapta a la cantidad de datos y al diseño de evaluación.
...
## 8. Contraste entre la transcripción y las diapositivas

El PDF confirma los temas tratados oralmente: centralidad y dispersión, distribuciones, estandarización, normas y pérdidas, comparación de distribuciones, pruebas de hipótesis, particiones y problemas de representatividad. Las diapositivas añaden diagramas y ejemplos numéricos que no se distinguen completos en la transcripción; su desarrollo queda en el [capítulo 1.5](../temario/bloque-1/1-5-conceptos-basicos-de-estadistica.md).

Al cotejar ambas fuentes, conviene corregir dos posibles lecturas:

- Con media 50 y desviación típica 10, el intervalo 30–70 es \(\mu\pm2\sigma\), aproximadamente el 95,45 % de una normal. El intervalo de tres sigmas es 20–80, aproximadamente el 99,73 %. Una mención de la transcripción que asocia 30–70 con tres sigmas parece un error de reconocimiento o de exposición.
- La estandarización *z-score* centra y escala los valores, pero no transforma por sí sola una distribución no normal en una normal. La forma original se conserva.

Para el resto de las cautelas estadísticas —interpretación de *p-values*, supuestos de KS y lectura de los tests por pares— véase el capítulo enlazado; las ampliaciones se distinguen allí de lo que la transcripción atribuye a la sesión.
...
- [1.5. Basic Concepts on Statistics](../temario/bloque-1/1-5-conceptos-basicos-de-estadistica.md)
